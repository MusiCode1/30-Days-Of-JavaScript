...
בסעיף הקודם הזכרנו מעט את הנושא של סוגי נתונים. לנתונים או לערכים של JavaScript יש כמה סוגי נתונים. סוגי הנתונים מתארים את סוג הערך הנתון נניח טקסט, או מספר. ניתן לחלק את סוגי הנתונים לשניים:

1. סוגי נתונים פרימיטיביים
2. סוגי נתונים לא פרימיטיביים (הפניות לאובייקטים)

### סוגי נתונים פרימיטיביים

סוגי נתונים פרימיטיביים ב- JavaScript כוללים:

1. מספרים - מספרים שלמים, צפים (מספר עם נקודה עשרונית)
2. מחרוזות - כל הנתונים תחת מרכאות בודדות, מרכאות כפולות או עם התו ``
3. בוליאנים - ערך של אמת או שקר
4. Null - ערך ריק או ללא ערך
5. Undefined - לא מוגדר. משתנה שהוצהר, אך עדיין ללא ערך
6. Symbol - סמל. ערך ייחודי שניתן ליצור על ידי בנאי סמלים


סוגי נתונים לא פרימיטיביים ב- JavaScript כוללים:

1. אובייקטים
2. מערכים

כעת, הבה נראה מה בדיוק המשמעות של סוגי נתונים פרימיטיביים ולא פרימיטיביים. סוגי נתונים *פרימיטיביים* הם סוגי נתונים שאינם ניתנים לשינוי. ברגע שאנו קובעים משתנה עם סוג נתונים פרימיטיבי איננו יכולים לשנות אותו.
